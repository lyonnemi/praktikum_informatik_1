...
int main()
{
    ...
    do
    {
        std::cout << "\nMenue:" << std::endl
                  ...
                  << "(s): Datenelemente sortieren" << std::endl
                  << "(0): Beenden" << std::endl;
        std::cin >> abfrage;
        std::cin.ignore(10, '\n');
        ...
        switch (abfrage)
        {
             ...
             * durch Anwendung der funltion find() von Library <algorithm>
             */
            case '5':
                {
                    ...
                    Student find_student(matrikelnummer, "", "" ,"");

                    auto it = std::find(studentenVektor.begin(), studentenVektor.end(), find_student);
                    if (it != studentenVektor.end()) {
                        std::cout << "Student: "<< *it <<std::endl;
                        std::cout << "Jetzt löschen..." << std::endl;
                        studentenVektor.erase(it);
                    } else {
            ...
            /**
             * @brief Datenelemente sortieren nach
             * durch Anwendung von std::sort der Library <algorithm> Liste ausgeben
             */
            case 's':

...
/**
 * @brief Vergleichsoperator für die Gleichheit
...
/**
 * @brief Vergleichsoperator für kleinere Matrikelnummern
 * @param other Der andere Student, mit dem verglichen wird
 * @return true, wenn die Matrikelnummern kleiner ist, sonst false
 */
bool Student::operator < (const Student& other) const {
    return this->matNr < other.matNr;
}
...
/**
 * @brief Vergleichsoperator für größere Matrikelnummern
 * @param other Der andere Student, mit dem verglichen wird
 * @return true, wenn die Matrikelnummern größer ist, sonst false
 */
bool Student::operator > (const Student& other) const {
    return this->matNr > other.matNr;
}

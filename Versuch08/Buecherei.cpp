...
void alleAusgeliehendeMediumsAusgeben(std::vector<Medium*>& medien);
...
int main()
{
    ...
    do  // Anzeige des Men�s
    {
        std::cout << std::endl
                  ...
                  << "(6): Ausgeliehenden Medien ausgeben" << std::endl
                  << "(7): Beenden" << std::endl;
        ...
        switch (abfrage)
        {
            ...
            case '6':
            {
                alleAusgeliehendeMediumsAusgeben(medien);
            }
...
//Alle ausgeliehende Medium ausgeben
void alleAusgeliehendeMediumsAusgeben(std::vector<Medium*>& medien)
{
    int count = 0;
    std::cout << "Ausgeliehende Medien in der B�cherei:" << std::endl;
    std::cout << "===================== " << std::endl;
    for (unsigned int index = 0; index < medien.size(); index++)
    {
        if (medien[index]->getStatus() == true){ //medien schon ausgeliehen
    ...
    if (count == 0) {
        std::cout << "Kein Medium aus der Bücherei ausgeliehen" << std::endl;
    }
    std::cout << "===================== " << std::endl;
}